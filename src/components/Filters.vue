...
export default {
  ...
  methods: {
    ...
    bigOriginPhote(selected) {
      this.dataUrl ? this.maxMin() : this.ctx.drawImage(this.waveImage, 0, 0);
    ...
    maxMin() {
      if (this.dataUrl) {
        ...
        if (
          this.img_width > this.canvasWidth &&
          this.img_height > this.canvasHeight
        ) {
          //如果宽高都大于canvas
          ...
          if (
            ...
            if (this.img_width < this.canvasWidth) {
              //宽小于
              this.r = this.canvasWidth / this.img_width;
            } else {
              //高小于
    ...
    originPhoto() {
      ...
      var originImgData = this.ctx11.getImageData(
        0,
        0,
        this.canvas11Width,
        this.canvas11Height
    ...
    blackWhite() {
      ...
      this.imgData1 = this.ctx1.getImageData(
        0,
        0,
        this.canvas1Width,
        this.canvas1Height
    ...
    reverse() {
      ...
      this.imgData2 = this.ctx2.getImageData(
        0,
        0,
        this.canvas2Width,
        this.canvas2Height
    ...
    frozen() {
      ...
      this.imgData3 = this.ctx3.getImageData(
        0,
        0,
        this.canvas3Width,
        this.canvas3Height
    ...
    comic() {
      ...
      this.imgData4 = this.ctx4.getImageData(
        0,
        0,
        this.canvas4Width,
        this.canvas4Height
    ...
    casting() {
      ...
      this.imgData5 = this.ctx5.getImageData(
        0,
        0,
        this.canvas5Width,
        this.canvas5Height
    ...
    brown() {
      ...
      this.imgData6 = this.ctx6.getImageData(
        0,
        0,
        this.canvas6Width,
        this.canvas6Height
    ...
    old() {
      ...
      this.imgData7 = this.ctx7.getImageData(
        0,
        0,
        this.canvas7Width,
        this.canvas7Height
    ...
    blurH() {
      ...
      this.imgData8 = this.ctx8.getImageData(
        0,
        0,
        this.canvas8Width,
        this.canvas8Height
    ...
    mosaic() {
      ...
      this.imgData9 = this.ctx9.getImageData(
        0,
        0,
        this.canvas9Height,
        this.canvas9Width
    ...
    emboss() {
      ...
      imageData = this.ctx10.getImageData(
        0,
        0,
        this.canvas10Width,
        this.canvas10Height
